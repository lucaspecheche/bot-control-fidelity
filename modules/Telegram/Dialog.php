...
use Exception as DialogException;

use Telegram\Bot\Actions;
use Telegram\Bot\Objects\Update;
use Telegram\Exceptions\TelegramExceptions;
...
class Dialog
{
    ...
    public function notLinked(): bool
    {
        return !$this->linked;
    }
    ...
    public function __construct(Update $update = null, bool $autoimport = false)
    {
        $this->update = $update;
        $this->toQuit();
    ...
    public function __call($name, array $args)
    {
        ...
        if (!is_array($step)) {
            throw TelegramExceptions::methodUndefined($step);
        }
